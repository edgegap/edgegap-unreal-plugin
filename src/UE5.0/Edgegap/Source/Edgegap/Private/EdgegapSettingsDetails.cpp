...
namespace{
	...
	void OnPackageCallaback(FString res, double num)
	{
		...
		AsyncTask(ENamedThreads::GameThread, [Settings, DockerFilePath, ServerBuildPath] {FEdgegapSettingsDetails::Containerize(DockerFilePath, StartScriptPath, ServerBuildPath, Settings->Registry, Settings->ImageRepository, Settings->Tag, Settings->PrivateRegistryUsername, Settings->PrivateRegistryToken); });
